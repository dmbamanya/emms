...
<table cellspacing=0 cellpadding=0 border=0>
  ...
  <tr><td class=label>{iLoanForm_fpdate_label}</td><td>{iLoanForm_fpdate_html}</td></tr>
...
<script>
  function showPlan(url) {
    ...
    xplan=window.open(url,windowname,'menubar=no,scrollbars=yes,resizable=no,width=800,height=400');
    xplan.focus();
