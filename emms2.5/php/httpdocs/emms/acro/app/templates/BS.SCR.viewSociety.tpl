  ...
  <tr>
    ...
    <td width=250px valign=top>
      <table>
        ...
        <tr><td><b>P</b>: {legend_president},<b>T</b>: {legend_treasurer},<b>S</b>: {legend_secretary}</td></tr>
      </table>
      <table>
        <!-- BEGIN memberlist -->
        <tr><td colspan=2><b>{group_name}<b></td><td>{move_button}</td><td>&nbsp;</td><td>{deactivate_button}</td></tr>
        <!-- BEGIN memberdetails -->
        <tr><td><b>{president}{treasurer}{secretary}</b></td><td>{member_name}</td></tr>
        <!-- END memberdetails -->
        <!-- END memberlist -->
      </table>
    </td>
