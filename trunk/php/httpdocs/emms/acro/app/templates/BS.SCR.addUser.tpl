...
{userForm_oldpassword_html}
  ...
  <tr>
    ...
    <td rowspan=2>{userForm_gender_html}<br><br></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td></td>
    <td class=label>{userForm_staff_label}</td>
    <td>{userForm_staff_html}</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class=label>{userForm_home_label}</td>
    <td colspan=4>{userForm_home_html}</td>
  </tr>
  <tr>
    <td class=label>{userForm_qjump_label}</td>
    <td colspan=4>{userForm_qjump_html}</td>
  </tr>
  <tr>
