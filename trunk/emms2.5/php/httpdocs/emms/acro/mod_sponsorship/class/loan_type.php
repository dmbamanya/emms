...
{  
  ...
  {
  $opt = explode(",", WEBPAGE::$gt['tblLoanTypes.payment_frequency.optList']);
  $nam = explode(",", WEBPAGE::$gt['tblLoanTypes.payment_frequency.optNames']);
  ...
  {
  $opt = explode(",", WEBPAGE::$gt['tblLoanTypes.borrower_type.optList']);
  $nam = explode(",", WEBPAGE::$gt['tblLoanTypes.borrower_type.optNames']);
  foreach ($opt as $key => $val) {
    $bt[$val] = $nam[$key];
    }
  return $bt;
  ...
  {
  $opt = explode(",", WEBPAGE::$gt['tblLoanTypes.calendar_type.optList']);
  $nam = explode(",", WEBPAGE::$gt['tblLoanTypes.calendar_type.optNames']);
  foreach ($opt as $key => $val) {
    $ct[$val] = $nam[$key];
    }
  return $ct;
